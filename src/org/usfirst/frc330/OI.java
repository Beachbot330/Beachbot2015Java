...
public class OI {
    ...
    public JoystickButton openLeft_1;
    public JoystickButton closeCenterGrabber_2;
    public JoystickButton closeRightGrabber_3;
    public JoystickButton adjustHandPositionUp_4;
    public JoystickButton receiveTote_5;
    public JoystickButton switchArmSide_7;
    public JoystickButton handLevel_8;
    public JoystickButton adjustHandPositionDown_9;
    public JoystickButton adjustHandPositionUp_10;
    public JoystickButton handLevel_11;
    ...
    public JoystickButton receiveTote_17;
    ...
    public OI() {
        ...
        receiveTote_17 = new JoystickButton(armGamepad, 5);
        receiveTote_17.whenPressed(new ReceiveTote());
        ...
        handLevel_11 = new JoystickButton(armGamepad, 11);
        handLevel_11.whenPressed(new HandLevel());
        adjustHandPositionUp_10 = new JoystickButton(armGamepad, 10);
        adjustHandPositionUp_10.whileHeld(new AdjustHandPositionUp());
        adjustHandPositionDown_9 = new JoystickButton(armGamepad, 9);
        adjustHandPositionDown_9.whileHeld(new AdjustHandPositionDown());
        ...
        receiveTote_5 = new JoystickButton(armGamepad, 5);
        receiveTote_5.whenPressed(new ReceiveTote());
        adjustHandPositionUp_4 = new JoystickButton(armGamepad, 4);
        adjustHandPositionUp_4.whenPressed(new AdjustHandPositionUp());
        closeRightGrabber_3 = new JoystickButton(armGamepad, 3);
        closeRightGrabber_3.whenPressed(new RightGrabberClose());
        closeCenterGrabber_2 = new JoystickButton(armGamepad, 2);
        closeCenterGrabber_2.whenPressed(new CenterGrabberClose());
        openLeft_1 = new JoystickButton(armGamepad, 1);
        openLeft_1.whenPressed(new LeftGrabberOpen());
