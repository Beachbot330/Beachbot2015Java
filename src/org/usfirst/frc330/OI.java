...
public class OI {
    ...
    public JoystickButton adjustHandPositionUp_6;
    public JoystickButton adjustHandPositionDown_7;
    public JoystickButton openAllGrabbers_3;
    ...
    public JoystickButton handDown_2;
    ...
    public OI() {
        ...
        handDown_2 = new JoystickButton(armJoystick, 2);
        handDown_2.whenPressed(new HandDown());
        ...
        openAllGrabbers_3 = new JoystickButton(armJoystick, 3);
        openAllGrabbers_3.whenPressed(new OpenAllGrabbers());
        adjustHandPositionDown_7 = new JoystickButton(armJoystick, 7);
        adjustHandPositionDown_7.whileHeld(new AdjustHandPositionDown());
        adjustHandPositionUp_6 = new JoystickButton(armJoystick, 6);
        adjustHandPositionUp_6.whileHeld(new AdjustHandPositionUp());
