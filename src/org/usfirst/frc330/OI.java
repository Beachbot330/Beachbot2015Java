...
public class OI {
    ...
    public JoystickButton closeCenterGrabber_9;
    public JoystickButton closeRightGrabber_8;
    public JoystickButton openLeftGrabber_5;
    public JoystickButton openCenterGrabber_6;
    public JoystickButton openRightGrabber_7;
    public JoystickButton openAllGrabbers_2;
    public JoystickButton setMastStretch_3;
    public JoystickButton setMastVertical_4;
    public JoystickButton switchArmSide_14;
    public JoystickButton adjustHandPositionUp_11;
    public JoystickButton adjustHandPositionDown_16;
    public JoystickButton killAll_13;
    public JoystickButton handLevel_12;
    public JoystickButton handDown_15;
    ...
    public OI() {
        ...
        handDown_15 = new JoystickButton(armJoystick, 15);
        handDown_15.whenPressed(new HandDown());
        handLevel_12 = new JoystickButton(armJoystick, 12);
        handLevel_12.whenPressed(new HandLevel());
        killAll_13 = new JoystickButton(armJoystick, 13);
        killAll_13.whenPressed(new KillAll());
        adjustHandPositionDown_16 = new JoystickButton(armJoystick, 16);
        adjustHandPositionDown_16.whileHeld(new AdjustHandPositionDown());
        adjustHandPositionUp_11 = new JoystickButton(armJoystick, 11);
        adjustHandPositionUp_11.whileHeld(new AdjustHandPositionUp());
        switchArmSide_14 = new JoystickButton(armJoystick, 14);
        switchArmSide_14.whenPressed(new SwitchArmSide());
        setMastVertical_4 = new JoystickButton(armJoystick, 4);
        setMastVertical_4.whenPressed(new SetMastVert());
        setMastStretch_3 = new JoystickButton(armJoystick, 3);
        setMastStretch_3.whenPressed(new SetMastStretch());
        openAllGrabbers_2 = new JoystickButton(armJoystick, 2);
        openAllGrabbers_2.whenPressed(new OpenAllGrabbers());
        openRightGrabber_7 = new JoystickButton(armJoystick, 7);
        openRightGrabber_7.whenPressed(new RightGrabberOpen());
        openCenterGrabber_6 = new JoystickButton(armJoystick, 6);
        openCenterGrabber_6.whenPressed(new CenterGrabberOpen());
        openLeftGrabber_5 = new JoystickButton(armJoystick, 5);
        openLeftGrabber_5.whenPressed(new LeftGrabberOpen());
        closeRightGrabber_8 = new JoystickButton(armJoystick, 8);
        closeRightGrabber_8.whenPressed(new RightGrabberClose());
        closeCenterGrabber_9 = new JoystickButton(armJoystick, 9);
        closeCenterGrabber_9.whenPressed(new CenterGrabberClose());
