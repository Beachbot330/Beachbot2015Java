...
public class OI {
    ...
    public JoystickButton canSnatchStart_4;
    public JoystickButton canSnatchFinish_5;
    ...
    public OI() {
        ...
        canSnatchFinish_5 = new JoystickButton(driverL, 5);
        canSnatchFinish_5.whenPressed(new CanSnatchFinish());
        canSnatchStart_4 = new JoystickButton(driverL, 4);
        canSnatchStart_4.whenPressed(new CanSnatchStart());
        ...
        SmartDashboard.putData("CanSnatchStart", new CanSnatchStart());

        SmartDashboard.putData("CanSnatchFinish", new CanSnatchFinish());

        SmartDashboard.putData("ExtendCanBurglar", new ExtendCanBurglar());

        SmartDashboard.putData("RetractCanBurglar", new RetractCanBurglar());
