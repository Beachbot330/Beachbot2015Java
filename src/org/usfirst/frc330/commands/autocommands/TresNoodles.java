...
public class TresNoodles extends BBCommandGroup {
    ...
    public  TresNoodles() {
    	...
    	addSequential(new TurnGyroAbs(0.0, 5.0, 1.5, true)); //angle tolerance timeout stop
    	addSequential(new DriveWaypointBackward(0.0, -30.0, 4.0, 2.0, false));  //X, Y, Tol, timeout, stop  - changed -23 to -19
    	addSequential(new Wait(0.2));
    }
}
