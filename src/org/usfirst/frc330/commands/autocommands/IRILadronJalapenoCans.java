 ...
 *
 */
public class IRILadronJalapenoCans extends BBCommandGroup {
    
    public  IRILadronJalapenoCans() {
        // Add Commands here:
    	...
    	addSequential(new DriveDistanceAtAbsAngle_NoTurn(150, 2, 0, 5, false)); //distance, distanceTolerance, angle, timeout, stopAtEnd
    }
}
