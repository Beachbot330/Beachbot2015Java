 ...
 *
 */
public class QuieroUnoJalapeno extends BBCommandGroup {
    
    public  QuieroUnoJalapeno() {
        // Add Commands here:
    	...
    	//New drive code
    	addSequential(new DriveDistanceAtAbsAngle(112, 2, -90.0, 3.0, false)); //distance, distanceTolerance, angle, timeout, stopAtEnd
    	addSequential(new TurnGyroAbs(0,5));
    	addSequential(new DriveDistanceAtAbsAngle(-60, 2, 0, 1.0, false)); //distance, distanceTolerance, angle, timeout, stopAtEnd
    }
}
