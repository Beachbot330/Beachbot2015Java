 ...
 *
 */
public class IRILadronJalapeno1657 extends BBCommandGroup {
    
    public  IRILadronJalapeno1657() {
        // Add Commands here:
...
//    	addSequential(new Wait(3.30));
    	...
    	addSequential(new DriveDistanceAtAbsAngle_NoTurn(50, 2, 0, 5, false, DriveLow, ChassisConst.DriveHigh, ChassisConst.GyroDriveLow, ChassisConst.GyroDriveHigh)); //distance, distanceTolerance, angle, timeout, stopAtEnd
    }
}
