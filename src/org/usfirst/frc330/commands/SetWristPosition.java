 ...
 *
 */
public class  SetWristPosition extends BBCommand {
	double angle;
	double timeout;
	double tolerance;
	...
	public SetWristPosition(double angle, double tolerance){
		this(angle, tolerance, -1.0);
	}
	
	public SetWristPosition(double angle, double tolerance, double timeout) {
